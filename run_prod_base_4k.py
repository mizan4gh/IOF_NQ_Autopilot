#!/usr/bin/env python3
"""Backtest baseline (M4 on, news on) at 4k volume bars.
Usage: python run_prod_base_4k.py <scid>
"""
import os, sys
...
OUT  = os.path.join(bt.BASE_DIR, f"IOF_NQ_prod_{stem}_base_vol4k.csv")
sys.argv = ["backtest.py", SCID, OUT]
print(f"\n##### PROD-base-4k {stem}: vol=4000 loss=800 noProfCap "
