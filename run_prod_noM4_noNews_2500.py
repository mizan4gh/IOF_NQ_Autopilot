#!/usr/bin/env python3
"""Backtest: M4 disabled, news filter OFF, 2.5k volume bars.
Usage: python run_prod_noM4_noNews_2500.py <scid>
"""
import os, sys
...
OUT  = os.path.join(bt.BASE_DIR, f"IOF_NQ_prod_{stem}_noM4_noNews_vol2500.csv")
sys.argv = ["backtest.py", SCID, OUT]
print(f"\n##### PROD-noM4-noNews-2500 {stem}: vol=2500 loss=800 noProfCap "
